...
class Server:
    """Server class to paginate database baby names.
    """
    ...
    def indexed_dataset(self) -> Dict[int, List]:
        """Dataset indexed by sorting position, starting 0
        """
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """
        constructs a dictionary metadata for the requested page and returns
        """
